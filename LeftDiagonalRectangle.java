/* *****************************************************************************
 *  Compilation:  javac LeftDiagonalRectangle.java
 *  Execution:    java LeftDiagonalRectangle
 *
 *  The LeftDiagonalRectangle class inherits the Shape Abstract Data Type and 
 ...
 *  method, which draws the left diagonal rectangle from its coordinates. It 
...
public class LeftDiagonalRectangle implements Shape {
    // instance variables
    ...
    // constants
    private final int ANGLE = 225;

    // constructor
    public LeftDiagonalRectangle(double x, double y, double radius) {
        this.x = x;
        this.y = y;
